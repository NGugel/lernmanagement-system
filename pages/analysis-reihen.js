      ...
      <Container className="marketing">
        ...
        <Row>
          <Col lg="4">
            ...
            <h2 className="fw-normal">Analysis {API.getRandomContent(1,2).frage}</h2>
        ...
        <Row>
          <Col lg="4"><Button variant="danger" href="#">Test1.1</Button></Col>
          <Col lg="4"><Button variant="danger" href="#">Test2.2</Button></Col>
          <Col lg="4"><Button variant="danger" href="#">Test3.3</Button></Col>
        </Row>
